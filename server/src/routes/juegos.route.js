...
import { createGame, deleteGame, findGamesWithFilters, getAllGames, getGame, updateGame } from "../controllers/juegos.controller.js";
import { verifyToken } from "../middlewares/authorization.js";
import { verifyAdmin } from "../middlewares/verifyAdmin.js";

const router = Router();

router.get('/juegos', findGamesWithFilters);
