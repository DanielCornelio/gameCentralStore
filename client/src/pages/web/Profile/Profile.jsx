        ...
        <Col md={8} className="mx-auto mb-4">
          ...
          >
            ...
            <Stack gap={2} className="justify-content-center">
              <div className="m-0">
                <h4 className="m-0 fs-1 d-inline">
                  {user?.nombre + " " + user?.apellido || "nombre de usuario"}
                </h4>
                <span className="ms-2 fs-5 text-gray">
              ...
              {recentPurchases.length > 0 ? (
                <div className="recent-purchases">
                  {recentPurchases.map((purchase) => (
                    <div
                      key={purchase.id}
                      className="purchase-item d-flex justify-content-between align-items-center py-2 border-bottom"
                    >
                      <div>
